    ...
    <header className="border-b bg-white/80 backdrop-blur-md sticky top-0 z-50">
      <div className="content-container flex h-16 items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Link to="/login">
            <Button variant="outline" className="hidden sm:inline-flex font-tinos">Login</Button>
          </Link>
          <Link to="/register">
            <Button className="hidden sm:inline-flex bg-[#313e7f] hover:bg-[#2b366f] text-white font-tinos">Get Started</Button>
          </Link>
