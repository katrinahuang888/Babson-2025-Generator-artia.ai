      ...
      <main className="flex-grow">
          ...
          <div className="content-container">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6 text-center md:text-left animate-fade-in">
                <h1 className="font-bold !leading-tight font-tinos">
                  Discover Authentic <span className="gradient-text text-[#313e7f]">Artisan</span> Crafts Filled With Heritage
                </h1>
                <p className="text-xl text-muted-foreground font-tinos">
                  An AI-powered marketplace bridging global designers, architects, and creators with artisan communities worldwide. Combining smart tech, visual tools, and cultural heritage — making custom, story-rich design accessible, efficient, and ethical.                
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                  <Link to="/register">
                    <Button size="lg" className="w-full sm:w-auto bg-[#313e7f] hover:bg-[#2b366f] text-white font-tinos">
                      <span>Get Started</span>
                      <ArrowRight className="ml-2 h-4 w-4" />
                    </Button>
                  </Link>
                  <Link to="/explore">
                    <Button size="lg" variant="outline" className="w-full sm:w-auto font-tinos">
                      Explore Artisans
                    </Button>
                  </Link>
                </div>
              ...
              <div className="relative rounded-xl overflow-hidden shadow-xl animate-slide-up">
                <div className="aspect-[4/3] bg-marketplace-purple/20">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <p className="text-lg text-marketplace-purple font-tinos">Handcrafted Pottery Collection</p>
                  </div>
                </div>
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-6">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="text-white">
                      <p className="font-medium font-tinos">Handmade Clay Pottery by @artisan</p>
                      <div className="flex items-center text-xs">
                        ...
                        <Star className="h-3 w-3 fill-yellow-400 text-yellow-400" />
                        <Star className="h-3 w-3 fill-yellow-400 text-yellow-400" />
                        <span className="ml-1 font-tinos">5.0</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <section className="py-16 bg-white">
          <div className="content-container">
            <div className="text-center mb-12">
              <h2 className="mb-4 font-tinos">How It Works</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-background p-6 rounded-lg shadow-sm relative pl-8">
                ...
                <h3 className="text-xl font-medium mb-2 font-tinos">Share Your Vision</h3>
                <p className="text-muted-foreground font-tinos">
              ...
              <div className="bg-background p-6 rounded-lg shadow-sm relative pl-8">
                <div className="step"></div>
                <h3 className="text-xl font-medium mb-2 font-tinos">Connect with Artisans</h3>
                <p className="text-muted-foreground font-tinos">
              ...
              <div className="bg-background p-6 rounded-lg shadow-sm relative pl-8">
                <div className="step"></div>
                <h3 className="text-xl font-medium mb-2 font-tinos">Receive Your Handcrafted Item</h3>
                <p className="text-muted-foreground font-tinos">
          ...
          <div className="content-container">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-sm text-center">
                ...
                <h3 className="text-xl font-medium mb-2 font-tinos">Authentic Craftsmanship</h3>
                <p className="text-muted-foreground font-tinos">
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm text-center">
                ...
                <h3 className="text-xl font-medium mb-2 font-tinos">Bespoke Creation</h3>
                <p className="text-muted-foreground font-tinos">
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm text-center">
                ...
                <h3 className="text-xl font-medium mb-2 font-tinos">Direct Communication</h3>
                <p className="text-muted-foreground font-tinos">
        ...
        <section className="py-16 bg-marketplace-purple text-black">
          <div className="content-container text-center">
            <h2 className="mb-4 font-tinos">Ready to Get Started?</h2>
            <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90 font-tinos">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/register?type=buyer">
                <Button size="lg" variant="secondary" className="w-full sm:w-auto border-black hover:text-gray-700 font-tinos">
              ...
              <Link to="/register?type=seller">
                <Button
                  size="lg"
                  variant="outline"
                  className="bg-white text-black border-black hover:bg-gray-100 hover:text-gray-700 w-full sm:w-auto font-tinos"
                >
                  Join as an Artisan
                </Button>
              </Link>
